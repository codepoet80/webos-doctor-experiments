...
enyo.kind({
	...
	components: [
		 ...
		 {kind: "HFlexBox", components: [
		 	{kind: "NotificationButton", className: "enyo-notification-button-alternate", flex: 1, onclick:"lunarestart", components:[{content: "Riavvia Luna"}]},
		 	{kind: "NotificationButton", className: "enyo-notification-button-alternate", flex: 1, onclick:"devicerestart", components:[{content: "Riavvia"}]},
		 ]},
		 {kind: "HFlexBox", components: [
