...
enyo.kind({
	...
	components: [
		 ...
		 {kind: "HFlexBox", components: [
		 	{kind: "NotificationButton", className: "enyo-notification-button-alternate", flex: 1, onclick:"lunarestart", components:[{content: "Reiniciar Luna"}]},
		 	{kind: "NotificationButton", className: "enyo-notification-button-alternate", flex: 1, onclick:"devicerestart", components:[{content: "Reiniciar Dispositivo"}]},
		 ]},
		 {kind: "HFlexBox", components: [
		 ...
		 {kind: "PalmService", name:"lunaRestartSvc", service:"palm://org.webosinternals.ipkgservice", method:"restartLuna"},
