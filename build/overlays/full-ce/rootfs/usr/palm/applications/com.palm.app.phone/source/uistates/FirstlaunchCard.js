enyo.kind({
	name: "UIStates.FirstlaunchCardState",
	kind: UIStates.AbstractState,
	setup: function(params, dontFocus) {
		enyo.application.openMainCard({firstlaunch:'true', params:params}, "", dontFocus);
	},
	cleanup: function() {
	...
	event_closed: function() {
		    ...
		    enyo.application.tellMainCard({scene:"firstlaunch_card", params: {fill:""}});
                } else { 
